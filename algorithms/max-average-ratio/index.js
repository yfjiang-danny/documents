 ...
 * @param extraStudents
 */
function answerA(classes, extraStudents) {
    var res = 0;
    while (extraStudents > 0) {
        var index = 0;
        var maxAmplitude = getAmplitude(classes[0][0], classes[0][1], 1);
        for (var i = 1; i < classes.length; i++) {
            var element = classes[i];
            var amplitude = getAmplitude(element[0], element[1], 1);
 ...
 * @param params
 */
function getAmplitude(pass, total, extra) {
...
var result = answerA(input1, input2);
